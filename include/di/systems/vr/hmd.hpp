#ifndef DI_SYSTEMS_VR_HMD_HPP_
#define DI_SYSTEMS_VR_HMD_HPP_
...
public:
  ...
  {
    return std::make_unique<di::mirror_texture_d3d11>(eye, device);
  }
  std::unique_ptr<mirror_texture_opengl> mirror_texture_opengl               (eye eye)                                                                                                                                                                                           const
  {
    return std::make_unique<di::mirror_texture_opengl>(eye);
  }
  ...
  std::unique_ptr<camera_stream>         camera_stream                       (                                   camera_frame_type type = camera_frame_type::distorted)                                                                                                          const
  {
    ...
    return std::make_unique<di::camera_stream>(handle, type);
  }
