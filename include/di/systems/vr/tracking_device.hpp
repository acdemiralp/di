#ifndef DI_SYSTEMS_VR_TRACKING_DEVICE_HPP_
#define DI_SYSTEMS_VR_TRACKING_DEVICE_HPP_
...
public:
  ...
  hand                                   hand                            () const
  {
    return static_cast<di::hand>(vr::VRSystem()->GetControllerRoleForTrackedDeviceIndex(index_));
  }
  ...
  std::unique_ptr<tracking_device_model> model                           () const
  {
    return std::make_unique<tracking_device_model>(render_model_name());
  }
